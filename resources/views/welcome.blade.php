...
<div class="row">
    ...
    <div class="col-md-4" id="palatino">
        <div class="card main-card shadow-sm">
...
<script>
    ...
    .then(function (response) {
        ...
        var totalLayout = new L.GeoJSON.AJAX("{{URL::asset('Hasil.json')}}",{style: style, onEachFeature: onEachFeature});
        var mapCenter = [{{  $taxpayer->lat ?? (request('latitude') ?? -2.322971)  }}, {{ $taxpayer->long ?? (request('longitude') ?? 119.356068) }}];
        var map = L.map('mapid', {
        ...
        info.update = function (props) {
            document.getElementById("taxpayer-info").innerHTML =
                '<h4>Kecamatan ' +  (props ? props.NAME_3 + "</h4>" +
                "Jumlah Penduduk : " + numeral(props.jumlah_penduduk).format('0,0') + "<br/>" +
                "Jumlah Penduduk yang bekerja: " + numeral(props.jumlah_penduduk-props.jumlah_pengangguran).format('0,0') + "<br/>" +
                "Jumlah Pengangguran: " + numeral(props.jumlah_pengangguran).format('0,0') + "<br/>"
        ...
        var colors = ['#CDF8D0', '#E2E8AC', '#ECE29D', '#fdbb84', '#FBD485', '#F8AE82', '#F7887D', '#990000'];
        //From Low to High
            ...
            myChart = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [
                    {
                        ...
                        data: [props.jumlah_pengangguran]
                    }, {
                        label: "Jumlah Penduduk",
                        backgroundColor: "rgba(54, 162, 235, 0.5)",
                        borderColor: ["rgba(54, 162, 235, 1)"],
                        data: [props.jumlah_penduduk]
                    }],
